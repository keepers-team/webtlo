...
// Other distributions do not install this Docker-only status pool.
$poolConfigDir = sprintf('/etc/php%d%d/php-fpm.d', PHP_MAJOR_VERSION, PHP_MINOR_VERSION);
if (!is_file("$poolConfigDir/worker-status.conf")) {
