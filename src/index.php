                ...
                <form id="config">
                    <div class="sub_settings">
                        ...
                        <div>
                            ...
                            <label class="label" title="Перечисление цифр значения пиров, используемые в зависимости от времени суток. Например, '3/4/5/6' или '3:4;5:12;4:8', где [4:8] - [лимит:размер временного интервала (ч.)]. (по умолчанию: пусто)">
