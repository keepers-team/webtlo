...
{
    /**
     * Признак изменения статуса через API.
     */
    ...
    /**
     * Признак явного указания хранения раздач.
     *
    ...
    /**
     * Маска "номера клиента" WebTLO.
     *
     * 0 - по умолчанию.
     *
     * Фактически, используем 3 бита, значение от 0 до 7.
     *
     * @see \KeepersTeam\Webtlo\Config\ReportSend->reporterId
     */
