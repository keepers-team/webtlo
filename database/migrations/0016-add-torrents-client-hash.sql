...
ALTER TABLE Torrents ADD COLUMN client_hash TEXT DEFAULT '';

-- Пустая строка означает, что идентификатор ещё неизвестен до следующего сканирования
-- или ручного действия. NULL означает, что он совпадает с хешем раздачи на форуме.
